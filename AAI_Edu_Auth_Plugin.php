 ...
 * License:           GPL-2.0+
 * Text Domain:       aaiedu-auth
 */

class AAI_Edu_Auth_Plugin {
	...
	public function __construct() {
		...
		// Spam check is ok.
		// add_filter( 'authenticate', 'wp_authenticate_spam_check');
	}
	...
	public function redirect_to_custom_login() {
		...
		// with the rest of the action in wp-login.php
		exit;
	}
...
$aai_auth_plugin = new AAI_Edu_Auth_Plugin();

// Register the plugin activation hook.
register_activation_hook( __FILE__, array( $aai_auth_plugin, 'plugin_activated' ) );

add_action( 'admin_notices', array( $aai_auth_plugin, 'display_plugin_notice') );
